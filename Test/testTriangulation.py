...
devices.append(ScanedDevice("rpi_1", "test_1", "AA:AA:AA:AA:AA:AA", -50))
devices.append(ScanedDevice("rpi_2", "test_1", "AA:AA:AA:AA:AA:AA", -50))
devices.append(ScanedDevice("rpi_3", "test_1", "AA:AA:AA:AA:AA:AA", -50))
devices.append(ScanedDevice("rpi_1", "test_2", "BB:BB:BB:BB:BB:BB", -50))
devices.append(ScanedDevice("rpi_2", "test_2", "BB:BB:BB:BB:BB:BB", -50))
devices.append(ScanedDevice("rpi_3", "test_2", "BB:BB:BB:BB:BB:BB", -50))
devices.append(ScanedDevice("rpi_1", "test_3", "CC:CC:CC:CC:CC:CC", -50))
devices.append(ScanedDevice("rpi_2", "test_3", "CC:CC:CC:CC:CC:CC", -50))
devices.append(ScanedDevice("rpi_3", "test_3", "CC:CC:CC:CC:CC:CC", -50))
